const AboutUs = () => {
  return (
    <section className="flex items-center justify-center bg-black border-t-[1px] border-purple py-[48px] md:py-[64px]">
      ...
      <div className="flex max-w-[95%] flex-col items-center justify-center gap-[32px] text-center md:max-w-[700px]">
        ...
        <a href="/about-us" className="btn text-[clamp(18px,10px_+_2vw,22px)]">
          About Us
        </a>
      </div>
    </section>
