    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-gray-900 rounded-lg p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-gray-400">Collections</p>
              <p className="text-2xl font-bold text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          >
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm">Create a new product</p>
            </div>
          </a>
          ...
          >
            ...
            <div>
              <p className="text-white font-medium">Bulk Upload</p>
              <p className="text-gray-400 text-sm">Upload catalog via CSV</p>
            </div>
          </a>
          ...
          >
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm">Create a collection</p>
            </div>
          </a>
        </div>
      </div>
      ...
      <div className="bg-gray-900 rounded-lg p-6">
        ...
        <div className="text-gray-400">
          ...
          <p className="text-sm mt-2">Activity tracking will be available soon.</p>
        </div>
      </div>
    </div>
  );
