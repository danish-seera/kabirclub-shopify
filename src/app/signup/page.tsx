...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center px-8 pb-24 pt-16">
      <div className="w-full max-w-sm">
        {/* Title */}
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-white mt-4">Join KabirClub</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-start">
              <input
                id="terms"
                type="checkbox"
                className="w-4 h-4 text-[#daa520] bg-gray-800 border-gray-700 rounded focus:ring-[#daa520] focus:ring-2 mt-1"
                required
              />
